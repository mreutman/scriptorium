...
\newcommand{\psalmKathismaStasis}[2] {
  \markboth
    {\hfill \addfontfeature{LetterSpace=10.0} DIVISIO #1,#2 \hfill}
    {\hfill \addfontfeature{LetterSpace=10.0} DIVISIO #1,#2 \hfill}
...

{
  ...
  et èx Patre natum ante òmnia sáĕcula;
  ...
  et incarnátus est de Spíritu Sancto èx María Vìrgine, et hòmo factus est.

  Crucifíxus étiam pro nobîs sùb Pòntio Piláto, passus et sepùltus est,

  et resurréxit tèrtia die, secùndum scriptúras,

  et ascèndit in caĕlum, sèdet ad dèxteram Patris.

  Et ìterum ventúrus est cum glória, judicáre vivos et mórtuos, cujus regni non èrit finis.

  \bigskip

  \noindent Et in Spíritum Sanctum, Dòminum et vivificántem, qŭi èx Patre procédit.

  Qŭi cum Patre et Fílio sìmul adorátur et conglorificátur; qŭi locútus est per profétas.
